declare module "react-native-sound-player" {
  ...
  interface SoundPlayerType {
    ...
    playAssetAsync: (asset: number) => Promise<void>;
    loadAssetAsync: (asset: number) => Promise<void>;
    ...
    /** If you set this option, your audio will be mixed with audio playing in background apps, such as the Music app. */
    setMixAudio: (on: boolean) => void;
    /** 0 means to play the sound once, other numbers indicate an indefinite loop. */
